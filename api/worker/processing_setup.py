...
from api.schemas.base_objects import Job
from api.worker.utils import get_temp_directory


class ProcessingSetup:
    def __init__(self, root_directory: str, job: Job):
    ...
    @staticmethod
    def from_job(job: Job, prefix="anno-page_processing"):
