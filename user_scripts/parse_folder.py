...
class Computator:
    def __init__(self, page_parser, input_image_path, output_alto_path, output_embeddings_path, output_render_path):
...
def main():
    ...
    computator = Computator(page_parser, input_image_path, output_alto_path, output_embeddings_path, output_render_path)
